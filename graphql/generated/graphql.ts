...
export type GetProjectsQuery = { projects: Array<{ id: string, title: string, projectType: ProjectType, date: string, excerpt: string | null, featured: boolean, slug: string, coverImage: { url: string } | null }> };
...
export type GetProjectQuery = { project: { id: string, title: string, projectType: ProjectType, createdAt: string, excerpt: string | null, updatedAt: string, embed: string | null, link: string, slug: string, description: { html: string }, coverImage: { url: string } | null } | null };
...
export type GetProjectMetadataQuery = { project: { id: string, title: string, createdAt: string, excerpt: string | null, embed: string | null, projectType: ProjectType, coverImage: { url: string } | null } | null };
